            ...
            <div className="flex flex-grow flex-col relative h-full items-center justify-center space-y-15">
                ...
                <div className="w-full max-w-[600px] space-y-2">
                    ...
                    <div className="grid grid-rows-1 grid-cols-2 gap-2 w-full h-full">
                        <button onClick={() => navigate("/book-flights")} className="bg-neutral-300 min-h-[400px] hover:scale-[101%] rounded-xl p-5 text-neutral-800 cursor-pointer hover:text-blue-400 duration-200 ease-linear shadow">
                        ...
                        <div className="grid grid-cols-1 grid-rows-2 rounded-xl gap-2">
                             <button onClick={() => navigate("/manage-flights")} className="bg-neutral-300 hover:scale-[101%] rounded-xl p-5 text-neutral-800 cursor-pointer hover:text-blue-400 duration-200 ease-linear shadow">
                                <div className="flex flex-col flex-grow relative h-full items-center justify-center space-y-3">
                             ...
                             <button onClick={() => navigate("/flight-services")} className="bg-neutral-300 hover:scale-[101%] rounded-xl p-5 text-neutral-800 cursor-pointer hover:text-blue-400 duration-200 ease-linear shadow">
                                <div className="flex flex-col flex-grow relative h-full items-center justify-center space-y-3">
